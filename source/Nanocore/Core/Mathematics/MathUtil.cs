...
namespace Nanocore.Core.Mathematics
{
    public static class MathUtil
    {
        ...
        public const float OneOverTwoFiveFive = 0.0039215689f;
        public const double OneOverTwoFiveFiveDouble = 1.0 / 255.0;
        ...
        public const float EpsilonNegative = -1.401298e-45f;
        ...
        public const float ThresholdSageRealSame = 0.00001f;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsNearlyEqual(float x, float y, float tolerance = ThresholdSageRealSame)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsNearlyZero(float x, float tolerance = ThresholdSageRealSame)
        {
